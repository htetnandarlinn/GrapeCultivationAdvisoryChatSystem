<footer class="bg-[#0d331a] text-[#aaa] px-5 py-[40px] md:px-[60px] md:py-[52px] pb-[32px]">

    <!-- Structural Grid Engine: 1 column on mobile, 2 columns on tablets, 4 columns on desktop layouts -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.8fr_1fr_1fr_1fr] gap-10 mb-10">
        ...
        <div class="space-y-3">
            ...
            <div class="flex items-center gap-2.5 pt-2">
                <a href="#" class="no-underline w-8 h-8 rounded bg-[#222] flex items-center justify-center text-[#aaa] text-sm hover:text-white transition-colors">
        ...
        <div>
            ...
            <ul class="list-none p-0 space-y-3">
                <li class="flex items-start gap-2.5 text-xs text-[#888]">
                    ...
                    <span>09 752479443</span>
                </li>
                <li class="flex items-start gap-2.5 text-xs text-[#888]">
                    <svg width="14" height="14" fill="#888" class="shrink-0 mt-0.5" viewBox="0 0 24 24">
                        <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                    </svg>
                    <a href="<?= BASE_URL ?>" class="no-underline text-[#888] hover:text-white transition-colors break-all">GrapeCultivationAdvisoryChatSystem</a>
                </li>
                <li class="flex items-start gap-2.5 text-xs text-[#888]">
                    <svg width="14" height="14" fill="#888" class="shrink-0 mt-0.5" viewBox="0 0 24 24">
                        <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                    </svg>
                    <span>Ywadan, Yamethin, Myanmar</span>
                </li>
            </ul>
        </div>
