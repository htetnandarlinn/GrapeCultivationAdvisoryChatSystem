...
<?php if (can('consultations.answer') && ($_SESSION['user_role'] ?? '') === 'expert'): ?>
        ...
        <a href="<?= BASE_URL ?>/expert/payouts" style="<?= active_style($is_active('expert/payouts')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-[#15803D]/10 hover:text-[#15803D]">
            <div class="flex items-center gap-3">
