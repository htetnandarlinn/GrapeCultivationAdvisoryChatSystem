...
function active_style($cond) {
    return $cond ? 'background:#059669!important;color:#fff!important;border-radius:12px!important;box-shadow:0 4px 6px -1px rgba(0,0,0,0.1)!important;' : '';
}
?>
...
<?php if (!empty($_SESSION['user'])): ?>
        <a href="<?= BASE_URL ?>/dashboard" style="<?= active_style(is_active('dashboard') && !is_active('admin/') && !is_active('notifications')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-emerald-50 hover:text-[#15803D]">
...
<?php if (can('users.view')): ?>
        <a href="<?= BASE_URL ?>/admin/users" style="<?= active_style(is_active('admin/users')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-emerald-50 hover:text-[#15803D]">
            <div class="flex items-center gap-3">
...
<?php if (can('consultations.view')): ?>
        <a href="<?= BASE_URL ?>/admin/consultations" style="<?= active_style(is_active('admin/consultations')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-emerald-50 hover:text-[#15803D]">
            <div class="flex items-center gap-3">
...
<?php if (can('consultations.view')): ?>
        <a href="<?= BASE_URL ?>/admin/payments" style="<?= active_style(is_active('admin/payments')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-emerald-50 hover:text-[#15803D]">
            <div class="flex items-center gap-3">
...
<?php if (can('consultations.answer') && ($_SESSION['user_role'] ?? '') === 'expert'): ?>
        <a href="<?= BASE_URL ?>/expert/consultations/hub" style="<?= active_style(is_active('expert/consultations/hub')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-emerald-50 hover:text-[#15803D]">
            <div class="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                Consultations
            </div>
        </a>
        <a href="<?= BASE_URL ?>/expert/farmers" style="<?= active_style(is_active('expert/farmers')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-emerald-50 hover:text-[#15803D]">
            <div class="flex items-center gap-3">
...
<?php if (can('articles.view')): ?>
        <a href="<?= BASE_URL ?>/expert/articles" style="<?= active_style(is_active('expert/articles')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-emerald-50 hover:text-[#15803D]">
            <div class="flex items-center gap-3">
        ...
        <a href="<?= BASE_URL ?>/expert/article-images" style="<?= active_style(is_active('expert/article-images')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-emerald-50 hover:text-[#15803D]">
            <div class="flex items-center gap-3">
...
<?php if (!empty($_SESSION['user'])): ?>
        <a href="<?= BASE_URL ?>/notifications" style="<?= active_style(is_active('notifications')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-emerald-50 hover:text-[#15803D]">
            <div class="flex items-center gap-3">
...
<?php if (!empty($_SESSION['user']) && ($_SESSION['user_role'] ?? '') === 'farmer'): ?>
        <a href="<?= BASE_URL ?>/consultation/my-consultations" style="<?= active_style(is_active('consultation/')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-emerald-50 hover:text-[#15803D]">
            <div class="flex items-center gap-3">
        ...
        <a href="<?= BASE_URL ?>/payment/history" style="<?= active_style(is_active('payment/history')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-emerald-50 hover:text-[#15803D]">
            <div class="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z"/></svg>
                Payment History
            </div>
...
<?php if (can('roles.view')): ?>
        <a href="<?= BASE_URL ?>/admin/roles" style="<?= active_style(is_active('admin/roles')) ?>" class="flex items-center justify-between p-3 rounded-xl font-bold text-sm transition-all text-slate-600 hover:bg-emerald-50 hover:text-[#15803D]">
            <div class="flex items-center gap-3">
