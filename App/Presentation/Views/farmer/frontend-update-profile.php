...
<section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 brand-input-focus">
    <div class="flex items-center justify-between mb-8">
        ...
        <a href="<?= BASE_URL ?>/my-profile" class="p-2.5 rounded-xl text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition inline-flex">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        <div class="lg:col-span-4 bg-white rounded-[28px] border border-slate-200 p-5 text-center flex flex-col items-center justify-between h-full">
            ...
            <div class="w-full space-y-0.5 pt-3 border-t border-slate-100">
                <a href="<?= BASE_URL ?>/my-profile" class="flex items-center gap-2.5 px-3.5 py-2 rounded-xl text-slate-600 hover:bg-slate-50 font-semibold text-xs transition-all group">
        ...
        <div class="lg:col-span-8 bg-white rounded-[28px] border border-slate-200 p-6">
            <form action="<?= BASE_URL ?>/profile/update" method="POST" enctype="multipart/form-data" novalidate class="space-y-4">
                ...
                <div class="flex items-center justify-end gap-2.5 pt-3 border-t border-slate-100">
                    <a href="<?= BASE_URL ?>/my-profile" class="px-3 py-2 text-xs font-bold text-slate-400 hover:text-slate-600 transition-colors">Cancel</a>
