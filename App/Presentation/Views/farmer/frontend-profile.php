...
<section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="flex items-center justify-between mb-8">
        ...
        <a href="<?= BASE_URL ?>/my-profile/edit" class="inline-flex items-center gap-1.5 px-5 py-2.5 bg-[#15803D] hover:bg-green-700 text-white font-bold text-xs rounded-xl transition-all">Edit Profile</a>
    </div>
