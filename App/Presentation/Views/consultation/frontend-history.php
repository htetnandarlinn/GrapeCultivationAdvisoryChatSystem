            ...
            <div class="flex-1 overflow-y-auto p-3 hide-scrollbar">
                ...
                <div id="sidebar-list" class="space-y-1">
                    ...
                    <div class="sidebar-item group flex items-start p-3.5 rounded-2xl transition-all border border-transparent hover:bg-slate-50/50 cursor-pointer"
                        ...
                        <div class="relative w-11 h-11 rounded-2xl <?= $theme['bg'] ?> flex items-center justify-center text-white font-bold text-[13px] tracking-wider shrink-0 shadow-sm shadow-black/5 transition-transform group-hover:scale-[1.02]">
...
function selectConsultation(id) {
    ...
    avatar.className = 'w-10 h-10 rounded-2xl ' + theme.bg + ' flex items-center justify-center text-white font-bold text-xs tracking-wider shrink-0 shadow-sm shadow-black/5';
